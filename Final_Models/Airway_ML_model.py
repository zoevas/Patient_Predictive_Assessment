...
filename = "models/airway_model.pickle"
pickle.dump(mlp_classifier, open(filename, "wb"))

explainer = shap.KernelExplainer(mlp_classifier.predict_proba, shap.kmeans(x_resampled, 100))

shap_values = explainer.shap_values(x_test)

pickle.dump(explainer, open('shap_models/airway_shap_explainer.pkl', "wb"))
